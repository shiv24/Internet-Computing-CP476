    ...
    <div class = "myBox">
        ...
        <div id = 'outside-buttons'>
          <div id = 'button-container'>
            <button class="main-buttons" href="addToWishList.php?id=<?php echo $PaintingId /* PaintingID  */ ?>&ImageFileName=<?php echo $imageName?>&Title=<?php echo urlencode($title)?>">Add to Wish List</button>
